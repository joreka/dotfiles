...
(defconst py-version "6.1.2-jnon1")
...
;; Faces
(defface py-import-name-face
  '((t (:inherit default)))
  ;; '((t (:inherit 'font-lock-variable-name-face)))
  "Highlight importea. "
  :group 'python-mode)
(defvar py-import-name-face 'py-import-name-face)

(defface py-import-alias-name-face
  '((t (:inherit py-import-name-face)))
  ;; '((t (:inherit 'font-lock-variable-name-face)))
  "Highlight aliased imports. "
  :group 'python-mode)
(defvar py-import-alias-name-face 'py-import-alias-name-face)
...
(setq py-font-lock-keywords
      ...
      `(,(rx symbol-start
        ...
        ;; imports
        (,(rx line-start symbol-start (or "import" "from") (1+ space) (group (1+ (or word ?_ ?.))))
         (1 py-import-name-face))
	;; import alias
        (,(rx line-start symbol-start "import" (1+ space) (1+ (or word ?_ ?.)) (1+ space) "as" (1+ space) (group (1+ (or word ?_ ?.))))
         (1 py-import-alias-name-face))
        ;; classes
        ...
        (,(lambda (limit)
         ...
         (1 py-variable-name-face nil nil))
        ;; Numbers
        (,(rx symbol-start (or (and (and ?0 ?x) (1+ hex-digit)) (1+ digit)) symbol-end) . py-number-face)))
